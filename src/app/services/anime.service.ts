...
import {Anime} from '../../../backend/models/anime';
...
export class AnimeService {
  ...
  unvote(anime, reviewId) {
    return this.http.delete<{ upvotesCount: Number }>(`https://localhost:3000/animes/${anime}/reviews/${reviewId}/upvotes/${this._auth.getId()}`, {});
  }
